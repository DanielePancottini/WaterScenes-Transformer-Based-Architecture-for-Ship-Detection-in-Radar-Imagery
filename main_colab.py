...
from data.WaterScenesDatasetColab import WaterScenesDatasetFromZip
...
# --- Set your paths ---
DATASET_ROOT = "/content/drive/MyDrive/Neural Networks/WaterScenes"
...
if __name__ == "__main__":
    ...
    train_dataset = WaterScenesDatasetFromZip(
        zip_dir=DATASET_ROOT,
        split_file=TRAIN_FILE,
        image_transform=image_transform
    )

    validation_dataset = WaterScenesDatasetFromZip(
        zip_dir=DATASET_ROOT,
        split_file=VAL_FILE,
        image_transform=image_transform
    )
